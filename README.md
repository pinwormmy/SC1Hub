...
- 고수봇은 자신의 채팅을 제외한 최신 채팅 3건을 GPT-5.6 Luna(`reasoningEffort=high`)로 한 번에 판별·작성하며, 다른 봇과 같은 공통값인 하루 1회 성공 발행과 최대 3회 시도를 사용합니다. 스타1 관련 대화가 있으면 가장 최근 관련 내용에 훈수를 두고, 없으면 독립적인 스타1 한 줄 공략을 게시합니다.
